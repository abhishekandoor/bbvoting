...
<div class="main-container animation-text">
    ...
    <div class="text-center"><a class="btn btn-outline-primary btn-rounded mt-3 px-5" href="<?php echo base_url() . 'index.php/ml/Home/dashboard' ?>">Malayalam - Season 6</a></div>
